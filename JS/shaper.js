...
return {
	...
	* To Arabic according to the shaperType & the textDir as the following:
	* 1-Arabic: if shaperType = "National".
	* 2-Arabic: if shaperType = "Contextual" & the preceding character is strong Arabic.
	* 3-Arabic: if shaperType = "Contextual" & textDir="rtl" & no preceding strong character.
	* 4-European: if shaperType = "Contextual" & the preceding character is strong Latin.
	* 5-European: if shaperType = "Contextual" & textDir="ltr" & no preceding strong character.
	*
